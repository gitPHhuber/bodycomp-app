...
const ROUTES = [
  {
    path: "/",
    title: "BODYCOMP — анализ состава тела: калькулятор и DXA-сканирование",
    description:
      "Узнайте свой процент жира, мышечную массу и метаболизм. Бесплатный калькулятор + запись на точный DXA-анализ.",
    url: `${BASE_URL}/`,
  },
  {
    path: "/analyzer",
  ...
  {
    path: "/expert-qa",
    title: "Экспертные Q/A по DXA и составу тела | BODYCOMP",
    description:
      "Ответы экспертов на частые вопросы о DXA-денситометрии, составе тела, проценте жира и интерпретации результатов.",
    url: `${BASE_URL}/expert-qa`,
  },
];
