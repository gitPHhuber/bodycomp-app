export const PROFILES = [
  { id: "a", name: "Анна", age: 34, w: 62, h: 168, bmi: 22.0, fat: 36, muscle: 38, verdict: "Skinny Fat", vc: "#ef4444", icon: "female", scale: "Весы: «62 кг — идеально!»", truth: "36% жира — скрытое ожирение. Мало мышц, висцеральный жир вокруг органов. Риск диабета повышен в 2 раза.", bmiL: "Норма ✓", bmiC: "#10b981", tip: "ИМТ 22 — «здорова». Но внутри — проблема, которую не видно." },
  { id: "d", name: "Дмитрий", age: 28, w: 92, h: 180, bmi: 28.4, fat: 15, muscle: 72, verdict: "Атлет", vc: "#10b981", icon: "male", scale: "Весы: «92 кг — срочно худей!»", truth: "15% жира. 72 кг чистой мышечной массы. Здоровее 90% людей с «нормальным» ИМТ.", bmiL: "Избыток ✗", bmiC: "#ef4444", tip: "ИМТ 28.4 — врач назначил бы диету здоровому атлету." },
  { id: "e", name: "Елена", age: 52, w: 68, h: 165, bmi: 25.0, fat: 28, muscle: 41, verdict: "Саркопения", vc: "#f59e0b", icon: "female2", scale: "Весы: «68 кг — стабильно 10 лет!»", truth: "−4 кг мышц, +4 кг жира за 10 лет. Тот же вес — совершенно другое тело. Риск переломов ×3.", bmiL: "Норма ✓", bmiC: "#10b981", tip: "Стабильный вес — опаснейшая иллюзия здоровья после 40." },
];
