...
const NAV_ITEMS = [
  ...
  { to: "/admin/funnel", label: "Воронка", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" },
  { to: "/admin/bookings", label: "Заявки", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
